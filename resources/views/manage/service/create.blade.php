        ...
        <form method="post" action="{{route('admin.service.store')}}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Create Service <a onclick="history.back()" class="btn btn-secondary"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="title" value="{{ old('title') }}"
                                            ...
                                            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Service Title">
                            ...
                            <p></p>
                            <button type="submit" class="btn btn-primary w-50 p-3">Add Service</button>
                        </div>
                    </div>
                </div>
